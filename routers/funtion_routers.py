...
funtion_router = Blueprint('funtion_router', __name__)
...
@funtion_router.route('/human_location', methods=['GET'])
...
@funtion_router.route('/face_landmarks', methods=['GET'])
def get_face_landmarks():
    landmarks = landmarks_detector.facelandmarks()
    return jsonify(landmarks)

# Route for face location
@funtion_router.route('/face_location', methods=['GET'])
