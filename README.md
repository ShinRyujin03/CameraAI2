...
- [Database Tables](#database-tables)
  ...
  - [`face_location` Table](#face-location-table)
  - [`face_landmark` Table](#face-landmark-table)
  - [`face_facial_attribute` Table](#face-facial-attribute-table)
  - [`face_verified` Table](#face-verified-table)
  - [`face_metadata` Table](#face-metadata-table)
  - [`human_location` Table](#human-location-table)
  - [`detected_objects` Table](#detected-objects-table)
